        ...
        <td class="header container">
            ...
            <div class="content">
                <table bgcolor="#999999">
                    <tr>
                        <td>
                            <img src="<?php echo base_url('/assets/img/transparent-logo.png'); ?>" style="width:200px"/>
                        </td>
                        <td align=" right"><h6 class="collapse">Thanks!</h6></td>
                    </tr>
                </table>
            </div>
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <!--&lt;!&ndash; Callout Panel &ndash;&gt;-->
                            <!--<p class="callout">-->
                            <!--Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.-->
                            <!--<a href="#">Do it Now! &raquo;</a>-->
                            <!--</p>&lt;!&ndash; /Callout Panel &ndash;&gt;-->
                            ...
                            <!--Email:-->
                            <!--<strong><a href="emailto:hseldon@trantor.com">hseldon@trantor.com</a></strong>-->
                            <!--</p>-->
